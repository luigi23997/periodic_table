...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_constraint UNIQUE (symbol);


--
-- Name: elements unique_constraint1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_constraint1 UNIQUE (name);
